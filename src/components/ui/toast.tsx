...
import { Check as MdCheckCircle, Error as MdError, Info as MdInfo } from "@mui/icons-material"
...
const ToastIcon = ({ variant }: { variant?: "default" | "destructive" | "success" | null }) => {
  ...
  switch (variant) {
    case "success":
      return <MdCheckCircle className={cn(iconClass, "text-green-600")} />
    case "destructive":
      return <MdError />
    default:
      return <MdInfo className={cn(iconClass, "text-blue-600")} />
  }
}
